\subsection{Testen der Korrektheit der \textit{scatter}-Funktion}
...
dass es eine funktionierende CPU Implementierung von der \textit{NNlib.jl} Bibliothek \cite{nnlib} gibt.
